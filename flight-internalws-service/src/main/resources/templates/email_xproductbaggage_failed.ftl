...
<head>
    ...
    <#if orderDetail.trademark == "Trip">
        ${getResource("xproductbaggageisusedfailedtitle")?replace('${"$"}{trademark}','Trip.com')}
    <#elseif orderDetail.trademark == "Ctrip">
        ${getResource("xproductbaggageisusedfailedtitle")?replace('${"$"}{trademark}','Ctrip')}
    </#if>
    </title>
    <style type="text/css">
                    ...
                    <td style="padding:5px 20px 0;">
                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                            ...
                            <tr>
                                ...
                                <#if orderDetail.trademark == "Trip">
                                    <p style="padding-top:5px;margin:0;line-height: 1.2;">${getResource("xproductbaggageisusedfailedContent")?replace('${"$"}{trademark}','Trip.com')}</p>
                                    <p style="padding-top:5px;margin:0;line-height: 1.2;">${getResource("xproductbaggageisusedfailedContent2")?replace('${"$"}{trademark}','Trip.com')}</p>
                                <#elseif orderDetail.trademark == "Ctrip">
                                    <p style="padding-top:5px;margin:0;line-height: 1.2;">${getResource("xproductbaggageisusedfailedContent")?replace('${"$"}{trademark}','Ctrip')}</p>
                                    <p style="padding-top:5px;margin:0;line-height: 1.2;">${getResource("xproductbaggageisusedfailedContent2")?replace('${"$"}{trademark}','Ctrip')}</p>
                                </#if>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                ${getResource("xproductbaggageisusedsuccessBaggageRefundAmount")} <span style="color:#2681FF;font-size:24px;margin-left: 5px;">${xproductBaggageDetail.currency} ${xproductBaggageDetail.totalAmount}</span>
                                </td>
                            </tr>
                        </table>
                    </td>
