<#assign mealsInfo = offlineValueAddedInfo.mealsInfo>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    <title>${offlineValueAddedInfo.statusDesc} - ${sharkMessageResource.offlineMeals}</title>
    <style type="text/css">
        td[class="blue"]:hover {
            cursor: pointer;
                ...
                <tr>
                    <td style="padding:5px 20px 0;">
                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tr>
                                <td style="font-family:Arial,sans-serif;font-size:32px;padding-bottom:20px;padding-top:20px;text-decoration:none;">${offlineValueAddedInfo.statusDesc} - ${sharkMessageResource.offlineMeals}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <#--乘机人区域-->
                                    <#if (mealsInfo.passengerNameList?? && mealsInfo.passengerNameList?size>=1)>
                                        <tr>
                                            <td valign="top"
                                            ...
                                            <td style="border-bottom:1px solid #dddddd;padding:7px 0 14px 10px;">
                                                <#list mealsInfo.passengerNameList as passengerName>
                                                    <#if (passengerName_index < mealsInfo.passengerNameList?size-1)>
                                                    ${passengerName},
                                                    <#else>
                                                    ${passengerName}
                                                    </#if>
                                        ...
                                        <tr>
                                            <td style="font-weight:700;padding:14px 10px 7px 0;">${sharkMessageResource.mealType}</td>
                                            <td style="padding:14px 10px 7px;">${mealsInfo.mealType}</td>
                                        </tr>
                                        <tr>
                                            <td style="font-weight:700;padding:7px 10px 7px 0;">${sharkMessageResource.quantity}</td>
                                            <td style="padding:7px 10px;font-size:12px;">x ${mealsInfo.number}</td>
                                        </tr>
                                        <tr>
                                            <td style="font-weight:700;border-bottom:1px solid #dddddd;padding:7px 10px 14px 0;">${sharkMessageResource.specialRequest}</td>
                                            <td style="border-bottom:1px solid #dddddd;padding:7px 10px 14px;">${mealsInfo.remarker}</td>
                                        </tr>
                                        <tr>
