...
public class HermesMySQLDemo {
	...
	public void oneboxTest() throws Exception {
		String topic = "starter.java.mysql";// TODO replace with your hermes topic methodDesc
		String consumerGroup = "starter.java.cgroup";// TODO replace with your hermes consumer group methodDesc
		...
		int i = 0;
		while (true) {
			System.out.println("Press any key to sendMessage message...");
			System.in.read();
