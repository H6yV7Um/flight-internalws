...
@XmlType(name = "AskReplySequenceRelationItem", namespace = "http://soa.ctrip.com/flight/Order/FlightOrderRebooking/v1", propOrder = {
    "segmentNo",
    "originSequence",
    "newSequence",
    "isRebookSequence",
...
public class AskReplySequenceRelationItem implements SpecificRecord {

    private static final long serialVersionUID = 1L;

	public static final Schema SCHEMA = Schema.parse("{\"type\":\"record\",\"name\":\"AskReplySequenceRelationItem\",\"namespace\":\"" + AskReplySequenceRelationItem.class.getPackage().getName() + "\",\"fields\":[{\"name\":\"segmentNo\",\"type\":\"int\"},{\"name\":\"originSequence\",\"type\":\"int\"},{\"name\":\"newSequence\",\"type\":\"int\"},{\"name\":\"isRebookSequence\",\"type\":\"boolean\"},{\"name\":\"isSurface\",\"type\":\"boolean\"}]}");

    @Override
    public Schema getSchema() { return SCHEMA; }

    public AskReplySequenceRelationItem(
        int segmentNo, 
        int originSequence, 
        int newSequence, 
    ...
    public boolean equals(Object obj) {
        ...
        final AskReplySequenceRelationItem other = (AskReplySequenceRelationItem)obj;
        return
